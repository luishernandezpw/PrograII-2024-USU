...
public class DB extends SQLiteOpenHelper {
    ...
    private static final String SQldb = "CREATE TABLE amigos(id text, rev text, idAmigo text, nombre text, direccion text, telefono text, email text, dui text, foto text, actualizado text)";
    ...
    public String administrar_amigos(String accion, String[] datos){
        try {
            ...
            if(accion.equals("nuevo")){
                db.execSQL("INSERT INTO amigos(id,rev,idAmigo,nombre,direccion,telefono,email,dui, foto, actualizado) VALUES('"+ datos[0] +"', '"+ datos[1] +"', '"+
                ...
                db.execSQL("UPDATE amigos SET id='"+ datos[0] +"',rev='"+ datos[1] +"', nombre='"+ datos[3] +"',direccion='"+ datos[4] +"',telefono='"+
                        datos[5] +"',email='"+ datos[6] +"',dui='"+ datos[7] +"', foto='"+ datos[8] +"', actualizado='"+ datos[9] +"' WHERE idAmigo='"+ datos[2] +"'");
